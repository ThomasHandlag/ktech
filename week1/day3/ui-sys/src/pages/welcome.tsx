  ...
  return (
    <div className="items-center justify-center flex flex-col h-screen p-4">
      <h1 className="text-4xl font-bold">
        Welcome to ktech practices and homework collection
      </h1>
      <p>
      ...
      <p>
        Use the navigation to explore my homework and practices components and
      ...
      <a
        href="https://github.com/ThomasHandlag/ktech"
        className="flex items-center"
      >
        Give me a ⭐ at <DiGithub size={40} />
        https://github.com/ThomasHandlag/ktech
      </a>
    </div>
  );
};
